...
prog_comp_rvc_sifive_formal:
	...
	-o program_file/$(RVC_TEST)/main.o $(CCF)
	riscv-none-embed-ld -o program_file/$(RVC_TEST)/main.elf -Map program_file/$(RVC_TEST)/main.map -T program/startup/rvc.ld program_file/$(RVC_TEST)/main.o $(LDF)
	riscv-none-embed-objdump -M no-aliases -S -w --disassemble-zeroes program_file/$(RVC_TEST)/main.elf > program_file/$(RVC_TEST)/main.lst
	riscv-none-embed-objcopy program_file/$(RVC_TEST)/main.elf program_file/$(RVC_TEST)/program.$(CPF)
	python program/startup/ihex2hex.py $(RVC_TEST)
